package ru.hackaton.vsu.votes.service;

import ru.hackaton.vsu.votes.exception.BadRequestException;
import ru.hackaton.vsu.votes.exception.ResourceNotFoundException;
import ru.hackaton.vsu.votes.model.*;
import ru.hackaton.vsu.votes.payload.PagedResponse;
import ru.hackaton.vsu.votes.payload.PollRequest;
import ru.hackaton.vsu.votes.payload.PollResponse;
import ru.hackaton.vsu.votes.payload.VoteRequest;
import ru.hackaton.vsu.votes.repository.PollRepository;
import ru.hackaton.vsu.votes.repository.UserRepository;
import ru.hackaton.vsu.votes.repository.VoteRepository;
import ru.hackaton.vsu.votes.security.UserPrincipal;
import ru.hackaton.vsu.votes.util.AppConstants;
import ru.hackaton.vsu.votes.util.ModelMapper;
